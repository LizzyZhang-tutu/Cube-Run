...
/// Smash_Spikes.
/// </summary>
public class Smash_Spikes : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        targetPos = normalPos + new Vector3(0, 0.6f, 0);
    ...
    private IEnumerator Down()
    {
        while (true)
        {
            son_Transform.position = Vector3.Lerp(son_Transform.position, normalPos, Time.deltaTime * 50);
            yield return null;
        }
    }
}
